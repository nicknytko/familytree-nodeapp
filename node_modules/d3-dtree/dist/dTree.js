...
(function (global, factory) {
    ...
    _createClass(TreeBuilder, [{
      ...
      value: function create() {
        ...
        this.zoom = d3.zoom().scaleExtent([0.1, 10]).on('zoom', function () {
          g.attr('transform', d3.event.transform.translate(width / 2, opts.margin.top));
        });

        //make an SVG
        var svg = this.svg = d3.select(opts.target).append('svg').attr('width', width).attr('height', height).call(this.zoom);

        var g = this.g = svg.append('g').attr('transform', 'translate(' + width / 2 + ',' + opts.margin.top + ')');
  ...
  var dTree = {
    ...
    init: function init(data) {
      ...
      this.zoom = treeBuilder.zoom;
      this.svg = treeBuilder.svg;
    },
